...
VALORES_EN_SERIE = {            # indicador: (mes, valor, tolerancia, ADR)
    ...
    # verificar este valor -de ahí que se mudó de VALORES_ESPERADOS a acá, no
    # que se haya dado de baja-. ±0,15 y no más: CABA marcaba 39,87 contra
    # 40,23 del nacional, y una tolerancia de 0,35 no distinguiría una columna
    # de la otra. El punto verificado es el último que tenía la SERIE
    # (`web/src/data/series.json`) al mudar este control.
    "icc_utdt": ("2026-08", 40.2, 0.15, "0242"),
}
