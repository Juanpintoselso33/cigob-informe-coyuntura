...
G3_EXCEPCIONES = {
    ...
    "desafios_legislativos": "misma familia de anclaje que derrotas_legislativas y bloqueo_sostenido, con los que comparte registro y ventana: card = conteo de 12 meses calendario anclado al MES EN CURSO (parcial); serie = el mismo conteo a cada fin de mes CERRADO. Con eventos discretos y pocos en ventana, cada desafío que entra o sale durante el mes corriente mueve el conteo de a enteros (hoy: card 10 sobre la ventana ago-2025→jul-2026 vs serie 11 al cierre de jun-2026, porque la ley 27.790 —desafiada el 10-jul-2025— salió de la ventana el 1 de julio) — no es desincronización de datos (2026-07-19)",
    "veto_quorum": "misma familia de anclaje que derrotas_legislativas, bloqueo_sostenido y desafios_legislativos: card = tasa de 12 meses calendario anclada al MES EN CURSO (fetch_veto_quorum evalúa en date.today()); serie = la misma tasa a cada fin de mes CERRADO (fetch_veto_quorum_serie). Desde que ADR-0091 lo pasó a ventana móvil, las dos ventanas están corridas un mes de forma permanente y con pocas sesiones en ventana cada una que entra o sale mueve el DENOMINADOR de a enteros (hoy: card 1/10 = 10,0 sobre sep-2025→ago-2026 vs serie 1/12 = 8,3 al cierre de jul-2026, porque las dos sesiones de ago-2025 —ambas con quórum— salieron de la ventana el 1 de agosto; el numerador es la misma única sesión en minoría del 21-jun-2026). El 31-jul-2026 pasaron por coincidencia, con las ventanas alineadas ese único día — no es desincronización de datos (2026-08-04)",
