...
export const LABELS: Record<string, string> = {
  ...
  saldo_comercial_12m: "Saldo comercial 12m", recaudacion: "Recaudación de impuestos internos (DGI)",
...
export const UNIDADES_CORTAS: Record<string, string> = {
  ...
  mora_familias: "%",
  peso_tarifas: "% m/m", alquiler_real: "% m/m", pobreza_nowcast: "%", indice_lider: "índice", consumo_carne: "kg/hab", informalidad: "%", mortalidad_pymes: "% m/m",
...
export const UNIDADES_LARGAS: Record<string, string> = {
  ...
  recaudacion: "% interanual real de la recaudación DGI (promedio móvil 3 meses)",
