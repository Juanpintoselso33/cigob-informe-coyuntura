...
export const LABELS: Record<string, string> = {
  ...
  peso_tarifas: "Peso de tarifas (regulados)", alquiler_real: "Costo real del alquiler", indice_lider: "Índice líder (anticipa el ciclo)",
...
export const UNIDADES_CORTAS: Record<string, string> = {
  ...
  mora_familias: "%",
  peso_tarifas: "% m/m", alquiler_real: "% m/m", indice_lider: "índice", consumo_carne: "kg/hab", informalidad: "%", mortalidad_pymes: "% m/m",
...
export const UNIDADES_LARGAS: Record<string, string> = {
  ...
  peso_tarifas: "% mensual", alquiler_real: "% mensual", indice_lider: "Índice (nivel)",
