...
export const LABELS: Record<string, string> = {
  ...
  idc: "Capacidad prestable", badlar: "Tasa BADLAR",
  ...
  actividad_tributaria: "Actividad tributaria (IVA-DGI + cheque)",
  ...
  tcrm: "Tipo de cambio real", rem_ipc_12m: "Expectativas inflación (REM 12m)",
  idm: "Brecha de crecimiento real M3–M2",
  desequilibrio_monetario: "Liquidez en pesos y presión compradora de divisas",
  iai: "Inversión física", icip: "Pagos de servicios digitales y productividad",
  ...
  asistencia_directa: "Asistencia directa", fal_modernizacion_laboral: "Fondo de Asistencia Laboral",
...
export const UNIDADES_CORTAS: Record<string, string> = {
  ...
  ipi_manufacturero: "% i.a.", actividad_tributaria: "% i.a. real",
  ipc_nucleo: "%", cuenta_corriente: "US$ M", pobreza_indec: "%",
...
export const UNIDADES_SERIE: Record<string, string> = {
  ...
  // ADR-0217/ADR-0322: la card publica el nivel per cápita oficial de SAGYP
  // (kg/hab) y la serie es el índice base-100 reconstruido desde la faena del
  // INDEC, que es lo único con historia para rebasear al 4T-2023. Sin esta
  // línea el gráfico rotulaba el índice como kilos: mostraba "95 kg/hab" al
  // lado de una card que decía 114,45 kg/hab, para el MISMO mes. ADR-0322
