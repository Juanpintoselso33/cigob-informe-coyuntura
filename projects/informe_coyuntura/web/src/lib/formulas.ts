...
export const FORMULAS: Record<string, Formula> = {
  ...
  presion_dolarizacion: {
    latex: String.raw`\begin{cases}P_t=f_{precio}\!\left(\overline{100\left(\frac{CCL}{TC_{may}}-1\right)}_{\,3m}\right),&\text{régimen restringido}\\[8pt]P_t=0{,}7\,f_{flujo}\!\left(100\,\frac{\sum \text{compras netas USD de personas humanas}}{\sum \left(M2_{privado,ARS}/TC_{may}\right)}\right)+0{,}3\,f_{flujo}\!\left(100\left(\frac{cripto}{TC_{may}}-1\right)\right),&\text{régimen abierto}\end{cases}\qquad \text{puntaje ITCM}=g(P_t),\;P_t\in[0,100]`,
    leyenda: "La señal cambia con el régimen. Hasta marzo de 2025 usa el promedio móvil de tres meses de la brecha CCL/mayorista. Desde abril combina dos canales sobre la misma ventana (1 mes en abril, 2 en mayo, 3 desde junio): 70% las compras netas de dólares de personas humanas como porcentaje del M2 privado expresado en USD (canal bancarizado), y 30% la brecha entre el dólar cripto y el mayorista (canal no bancarizado). Si falta el dato de dólar cripto, la presión queda 100% del primer canal. Todas las métricas se convierten a presión 0–100; mayor presión implica menor puntaje ITCM.",
  },
  recaudacion: {
