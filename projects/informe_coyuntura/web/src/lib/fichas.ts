...
export const FICHAS: Record<string, Ficha> = {
  ...
  itcm: {
    ...
    validacion: [
      ...
      "El ancla fue el riesgo país (EMBI) hasta julio de 2026 y se cambió por un motivo medido: el EMBI acompañaba al índice en niveles y en ventanas semestrales, pero su co-movimiento era nulo en los saltos de un mes — el mercado reacciona en el día mientras el índice publica con el rezago y el suavizado de sus fuentes, y sus sobresaltos mensuales suelen ser políticos antes que macroeconómicos. La actividad, en cambio, sostiene la correlación también mes a mes, que es la prueba que no se puede satisfacer con la tendencia común del período. El riesgo país se conserva en la matriz de validación cruzada, donde sigue aportando. Ambas correlaciones (niveles y cambios mes a mes) se publican en la página del cinturón.",
