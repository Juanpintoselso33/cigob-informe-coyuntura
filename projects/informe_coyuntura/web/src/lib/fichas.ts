...
export const FICHAS: Record<string, Ficha> = {
  ...
  desregulacion_normativa: {
    ...
    fuente: {
      ...
      operacion: "Análisis de la desregulación implementada, informe mensual — normas de desregulación acumuladas desde el 10 de diciembre de 2023",
    ...
    transformaciones: [
      "El valor del mes es la cifra que el propio informe publica en su portada; no hay recálculo del proyecto.",
      ...
      "La serie histórica hasta abril de 2026 se reconstruyó midiendo las barras del gráfico de normas acumuladas que publica el informe, porque ese gráfico es la única fuente oficial con detalle mes a mes desde diciembre de 2023. La medición se calibró con la cifra de portada del mismo informe y se contrastó contra las cifras de los demás, que son independientes del gráfico.",
    ],
    anclas: {
      bandas: [
        { banda: "> 1.200", puntaje: 100 },
        { banda: "600 – 1.200", puntaje: 85 },
        { banda: "300 – 600", puntaje: 60 },
        { banda: "100 – 300", puntaje: 35 },
        { banda: "≤ 100", puntaje: 10 },
      ],
      puntos: [[100, 10], [200, 35], [450, 60], [900, 85], [1200, 100]],
      unidadCorta: "normas",
    },
    limitaciones: [
      "Es el Gobierno midiendo su propio programa. El criterio de qué norma cuenta como «de desregulación» lo fija el ministerio responsable, y no hay un tercero que lo audite. Es la contrapartida de usar la cifra oficial en lugar de una reconstrucción propia.",
      "La escala de referencia es una convención del proyecto. El ministerio publica el conteo pero no declara ninguna meta, así que el punto en que la desregulación se considera completa lo fijamos nosotros. Conviene leer el indicador por su evolución más que por su nivel absoluto.",
      "El conteo trata como equivalentes normas de peso económico muy distinto: una que libera un mercado entero cuenta igual que una que simplifica un trámite menor.",
      "El ministerio revisa su serie hacia atrás, y lo ha hecho de forma sustantiva: el informe de junio de 2025 declaraba doscientas doce normas a esa fecha, mientras el gráfico publicado en abril de 2026 ubica ese mismo momento por encima de trescientas. El informe publica la versión corregida y es la que se usa, del mismo modo que se usa la última revisión de una serie estadística.",
      "La serie anterior a abril de 2026 proviene de la medición de un gráfico y no de cifras publicadas como texto. El contraste contra las cifras de portada disponibles arroja diferencias de hasta tres normas.",
      "Es un conteo normativo, no una auditoría del efecto económico de lo desregulado.",
    ],
