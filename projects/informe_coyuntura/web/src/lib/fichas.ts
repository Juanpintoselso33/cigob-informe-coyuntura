...
export const FICHAS: Record<string, Ficha> = {
  ...
  velocidad_resolucion: {
    ...
    fuente: {
      ...
      acceso: "Carga manual anual: los tableros interactivos no admiten consulta automática; el valor se releva de la versión estática de cada hoja y se valida contra el anuario en documento.",
    },
    transformaciones: [
  ...
  recaudacion: {
    ...
    fuente: {
      ...
      serie: "172.3_SOTAL_DDGI_M_0_0_12 + IPC 148.3_INIVELNAL_DICI_M_26 (API de datos.gob.ar) + gacetilla mensual de recaudación de la Comisión Arbitral. Descomposición (no puntúa): IVA-DGI 142.3_IVA_D_2001_M_7 y créditos/débitos bancarios 142.3_CREDI_2001_M_24 —dos de los propios componentes del agregado DGI—, mismo IPC como deflactor.",
      url: "https://www.afip.gob.ar/institucional/estudios/",
  ...
  desafios_legislativos: {
    ...
    fuente: {
      ...
      acceso: "Semiautomático: clasifica las actas de votación de ambas cámaras y las cruza con los vetos de InfoLeg; los casos ambiguos del registro compartido con bloqueo sostenido quedan pendientes de revisión humana.",
    },
    transformaciones: [
  ...
  apoyo_empresario: {
    ...
    incidenciaTexto: [
      ...
      "Pesa la mitad de la dimensión de sector privado; la otra mitad es la brecha de expectativas entre obra pública y obra privada. Estuvo suspendido de agosto a septiembre de 2026 y volvió con el mismo peso de diseño, que durante la suspensión quedó escrito sin tocar.",
      "El reparto es parejo porque miden cosas distintas y ninguna domina a la otra: la brecha es una medida revelada —lo que las empresas esperan, con dato duro del INDEC— pero de un solo sector; ésta es una medida declarada —lo que las cámaras dicen y firman— directa sobre la relación con el Gobierno y sobre cualquier tema, pero de sólo dos entidades.",
    ],
    limitaciones: [
  ...
  fal_modernizacion_laboral: {
    ...
    fuente: {
      ...
      acceso: "Semiautomático: los actos normativos y las suspensiones judiciales se verifican y asientan en un registro versionado; los fondos registrados en la Comisión Nacional de Valores se leen automáticamente. Las menciones del instrumento en el Boletín Oficial y el conteo amplio de fondos de cese se muestran como contexto y no inciden en el puntaje.",
    },
    transformaciones: [
    ...
    anclas: {
      bandas: [
        { banda: "> 90", puntaje: 100 },
        { banda: "62,5 – 90", puntaje: 80 },
        { banda: "37,5 – 62,5", puntaje: 55 },
        { banda: "10 – 37,5", puntaje: 30 },
        { banda: "≤ 10", puntaje: 10 },
      ],
  ...
  consumo_carne_vacuna: {
    ...
    fuente: {
      ...
      operacion: "Nivel: SAGYP — Dirección Nacional de Producción Ganadera, tablero de consumo per cápita de carnes, promedio móvil de 12 meses (vacuna). Evolución: faena mensual en toneladas de vacunos (INDEC, serie 40.3_VT_0_M_17), per cápita con la población proyectada del INDEC.",
  ...
  consumo_carnes_otras: {
    tipo: "indicador",
    id: "consumo_carnes_otras",
    cinturon: "vida_cotidiana",
    rezago: "El tablero oficial publica el mes con unas semanas de demora; la faena del INDEC, con dos meses. El titular avanza con el tablero y el índice con la faena.",
    fuente: {
      organismo: "SAGYP (nivel) e INDEC (evolución)",
      operacion: "Nivel: SAGYP — Dirección Nacional de Producción Ganadera, tablero de consumo per cápita de carnes, promedio móvil de 12 meses (aviar + porcina). Evolución: faena mensual en toneladas de porcinos y aves (INDEC, series 40.3_PT_0_M_18 · 40.3_AT_0_M_14), per cápita con la población proyectada del INDEC.",
      url: "https://www.magyp.gob.ar/sitio/areas/bovinos/informacion_sectorial",
      acceso: "Automático: lectura mensual del PDF del tablero y de la API de series de tiempo del INDEC.",
    },
    transformaciones: [
