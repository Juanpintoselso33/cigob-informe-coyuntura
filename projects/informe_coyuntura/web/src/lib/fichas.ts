...
export const FICHAS: Record<string, Ficha> = {
  ...
  recaudacion: {
    ...
    fuente: {
      ...
      serie: "172.3_SOTAL_DDGI_M_0_0_12 + IPC 148.3_INIVELNAL_DICI_M_26 (API de datos.gob.ar) + gacetilla mensual de recaudación de la Comisión Arbitral. Control (no puntúa): IVA-DGI 142.3_IVA_D_2001_M_7 y créditos/débitos bancarios 142.3_CREDI_2001_M_24, mismo IPC como deflactor.",
