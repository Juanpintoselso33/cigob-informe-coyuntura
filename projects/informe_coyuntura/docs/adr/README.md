...
| [0215](0215-la-carne-se-mide-con-dos-fuentes-y-se-declara.md) | La carne se mide con dos fuentes, y eso se declara | `consumo_carne`, `consumo_carnes_total` | superado por [0217](0217-puntua-el-acceso-total-a-proteina-no-la-vacuna.md) |
...
| [0322](0322-la-vacuna-vuelve-a-puntuar-junto-al-resto-de-las-carnes.md) | La vacuna vuelve a puntuar, junto al resto de las carnes | `consumo_carne_vacuna`, `consumo_carnes_otras`, `consumo_carnes_total` | superado por [0339](0339-puntua-el-total-de-carnes-y-la-vacuna-aparte.md) |
| [0323](0323-ratio-motos-autos-como-control-de-la-motorizacion.md) | El ratio motos/autos entra como control dentro de la card, no como indicador | `motorizacion_total` | superado por [0328](0328-ratio-motos-autos-puntua-como-indicador-propio.md) |
| [0324](0324-el-snic-conserva-homicidios-por-nombre-no-por-ranking.md) | El SNIC conserva homicidios por nombre, no por ranking de volumen | `inseguridad_snic` | superado por [0327](0327-homicidios-y-robos-del-snic-puntuan-en-seguridad.md) |
| [0325](0325-correcciones-a-la-tanda-carne-motos-snic.md) | Correcciones a la tanda carne/motos/SNIC (ADR-0322/0323/0324) | `consumo_carne_vacuna`, `consumo_carnes_otras`, `inseguridad` | superado por [0327](0327-homicidios-y-robos-del-snic-puntuan-en-seguridad.md) |
