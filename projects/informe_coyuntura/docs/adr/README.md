...
| [0041](0041-cohesion-bloque-diputados-cache-permanente-y-serie-mensual.md) | `cohesion_bloque` (Diputados): caché permanente por acta (cada PDF se descarga una sola vez en la vida del proyecto) + serie mensual real vía backfill | Aceptado |
...
| [0043](0043-protestas-caba-recalibracion-bandas.md) | `protestas_caba`: anclas var_vs_2023 recalibradas −30/−10/10/30 → −6/−3/0/10 con los 30 puntos reales de la serie ACLED ya existente | Aceptado |
| [0044](0044-adhesion-reformas-provincial-serie-mensual.md) | `adhesion_reformas_provincial`: serie mensual real vía investigación manual de la fecha de adhesión de cada provincia (dataset curado versionado); anclas chequeadas y NO recalibradas (adhesión = trinquete irreversible) | Aceptado |
| [0045](0045-comisiones-caidas-recalibracion-bandas.md) | `comisiones_caidas`: anclas ITCP recalibradas 30/50/70/85 → 96/97/98/99 con 32 puntos mensuales reales; el piso estructural de la métrica es 94,7 y las anclas del doc dejaban los 32 meses clavados en tensión máxima | Aceptado |
