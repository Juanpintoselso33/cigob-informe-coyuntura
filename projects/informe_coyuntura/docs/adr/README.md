...
| [0027](0027-auditoria-idc-rediseno.md) | Auditoría adversarial del IdC vs la literatura FCI (NFCI/Goldman/Bloomberg): leyenda con signo invertido CORREGIDA; quedan doble conteo de depósitos, asignación mal condicionada, derivada-no-nivel y sin estacionalidad — 4 opciones de rediseño a decidir con CIGOB | Abierto |
