...
| [0050](0050-eficacia-legislativa-recalibracion-bandas.md) | `eficacia_legislativa`: anclas ITCP recalibradas 5/15/35/55 → 1/3/5/7 con 32 puntos mensuales reales (rango 0–8,7%); el numerador exige sanción dentro de la misma ventana de 365d que la publicación del proyecto — techo estructuralmente deprimido, misma patología en espejo que 0045; de paso se corrigen los pesos internos stale de las 4 fichas web de poder legislativo (pre-0046) | Aceptado |
