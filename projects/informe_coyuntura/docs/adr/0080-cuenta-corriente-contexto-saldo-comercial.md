...
|---|---|
| **Estado** | Aceptado |
| **Ámbito** | Cinturón macro · `saldo_comercial_12m` · serie acompañante `cuenta_corriente` |
| **Fecha** | 2026-07-18 |
| **Precedentes directos** | ADR-0077 (patrón de serie acompañante en el modal) · ADR-0056 (regla automática del saldo) |
