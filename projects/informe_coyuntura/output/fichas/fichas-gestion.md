...
Este documento tiene una ficha por indicador — son 13 en total, y cada una arranca en página nueva. Antes de las fichas, el cinturón completo de un vistazo.
...
| | | | |
|---|---|---|---|
| **ITCG: 79,4** | **VERDE** | Moderadamente aflojado | 13 indicadores: 9 en verde · 4 en amarillo |

## Dimensiones

| Dimensión | Qué mide | Puntaje | Color | Peso |
|---|---|---|---|---|
| Reformas económicas fundamentales | El corazón de la promesa económica: cepo desarmado (brecha cambiaria), comercio exterior abierto (alícuota efectiva) y desregulación normativa. | 75,3 | VERDE | 35,0 % |
...
| Privatizaciones e inversión | Los activos del Estado y la inversión privada grande: privatizaciones, cartera del RIGI y concesiones viales. | 68,7 | VERDE | 15,0 % |
...
| Brecha cambiaria (cepo) | Cuánto se separa el dólar financiero (CCL) del dólar mayorista de referencia: la brecha cambiaria. | 6,13 % de brecha CCL/mayorista | VERDE | 14,0 % |
...
| Dotación del Estado (APN) | Cuánto varía la dotación de personal de la Administración Pública Nacional respecto de diciembre de 2023 (inicio del… | −20,36 % de variación vs dic-2023 (dotación APN) | VERDE | 14,6 % |
| Gasto de funcionamiento | Cuánto varía en términos reales el gasto de funcionamiento del Estado nacional respecto de 2023. | −31,37 % de variación real vs 2023-06 (IMIG funcionamiento) | VERDE | 10,4 % |
...
| Inversiones RIGI | Cuánto de la inversión del Régimen de Incentivo a Grandes Inversiones (RIGI) ya está aprobada. | 23,7 % de inversión aprobada sobre el pipeline | AMARILLO | 6,0 % |
...
| | | | |
|---|---|---|---|
| **Hoy: 6,13 % de brecha CCL/mayorista** (2026-08) | **VERDE** | Peso efectivo 14 % del ITCG | Cinturón Gestión |
...
| **MODO DE ACCESO** | Automático: API pública de cotizaciones; la serie histórica se reconstruye con el CCL promedio del mes sobre el mayorista promedio. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-08-27 |
...
- El informe publica el valor (6,13 % de brecha CCL/mayorista) pero no los números que lo componen: la fuente entrega la serie ya calculada. Para auditar el dato hay que ir a la operación estadística citada más arriba.

## Color vigente y por qué

Dato vigente: 6,13 % de brecha CCL/mayorista (2026-08).

6,13 % de brecha CCL/mayorista cae en el tramo que corresponde a Verde, a 7,87 del corte más cercano.
...
| **MODO DE ACCESO** | Automático: APIs públicas de series de tiempo y del BCRA. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-08-27 |
...
| **MODO DE ACCESO** | Automático: se leen los enlaces de la página oficial y se extrae la cifra de portada de cada informe en PDF. Los nombres de archivo son irregulares, de modo que los enlaces se resuelven leyendo la página y nunca se arman a mano. Cada informe publicado se conserva, porque su contenido no cambia. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-08-27 |
...
| | | | |
|---|---|---|---|
| **Hoy: −20,36 % de variación vs dic-2023 (dotación APN)** (2026-06) | **VERDE** | Peso efectivo 14,6 % del ITCG | Cinturón Gestión |
...
| **MODO DE ACCESO** | Automático: lectura de la planilla oficial. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-08-27 |
...
| | | | |
|---|---|---|---|
| **Hoy: −31,37 % de variación real vs 2023-06 (IMIG funcionamiento)** (2026-06) | **VERDE** | Peso efectivo 10,4 % del ITCG | Cinturón Gestión |
...
| **MODO DE ACCESO** | Automático: API pública de series de tiempo. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-08-27 |
...
| **MODO DE ACCESO** | Automático: lectura de la planilla oficial. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-05 · informe generado el 2026-08-27 |
...
| **MODO DE ACCESO** | Registro curado a mano con seguimiento quincenal del Boletín Oficial: no existe una fuente única automatizable (ni la agencia responsable ni la comisión bicameral publican un tablero). | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-08-27 |
...
| | | | |
|---|---|---|---|
| **Hoy: 23,7 % de inversión aprobada sobre el pipeline** (2026-08) | **AMARILLO** | Peso efectivo 6 % del ITCG | Cinturón Gestión |
...
| **SERIE DISPONIBLE** | 2023-12 → 2026-08 (27 puntos) | **REZAGO DE PUBLICACIÓN** | Sin rezago: foto de la plataforma oficial al día de la actualización. |
...
| **MODO DE ACCESO** | Automático: lectura de la planilla pública de la plataforma oficial; las fechas de aprobación se toman del Boletín Oficial solo para proyectos nuevos. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-08-27 |
...
- 22 proyectos aprobados (US$ 47.073M) / 22 en evaluación (US$ 151.936M) → 23,7% de la inversión total ya aprobada

## Color vigente y por qué

Dato vigente: 23,7 % de inversión aprobada sobre el pipeline (2026-08).

23,7 % de inversión aprobada sobre el pipeline cae en el tramo que corresponde a Amarillo, a 5,8 del corte más cercano.
...
| | | | |
|---|---|---|---|
| **Hoy: 100 % de km adjudicados / km del plan (Red Federal de Concesiones)** (2026-08) | **VERDE** | Peso efectivo 3 % del ITCG | Cinturón Gestión |
...
| **MODO DE ACCESO** | Automático: el estado de cada proceso licitatorio se lee de CONTRAT.AR (búsqueda pública, sin usuario) y el kilometraje por etapa de la página oficial de la Red. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-08-27 |
...
- 9.091 de 9.091 km adjudicados · I: adjudicada (CONTRAT.AR) · II-B: adjudicada por Resolución 1149 / 2026 (2026-07-28) · II: adjudicada (CONTRAT.AR) · III: adjudicada por Resolución 1379 / 2026 (2026-08-24) · CONTRAT.AR todavía no refleja la adjudicación de II-B, III, que constan en el Boletín Oficial

## Color vigente y por qué

Dato vigente: 100 % de km adjudicados / km del plan (Red Federal de Concesiones) (2026-08).

100,0 % de km adjudicados / km del plan (Red Federal de Concesiones) cae en el tramo que corresponde a Verde, a 59,0 del corte más cercano.
...
| **MODO DE ACCESO** | Automático: API oficial con credencial de acceso; la línea de base 2023 (ejercicio cerrado) se calculó una vez y quedó fijada. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-08-27 |
...
| **MODO DE ACCESO** | Semiautomático: un detector avisa cuando aparece un año nuevo y una persona carga en el registro curado el anclaje anual con su fuente pública. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2025-12 · informe generado el 2026-08-27 |
...
| **MODO DE ACCESO** | Automático: lectura de las planillas oficiales; las prepagas inscriptas como Agentes del Seguro se identifican por su rango de código de registro (canal creado por el DNU 70/2023). | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-03 · informe generado el 2026-08-27 |
