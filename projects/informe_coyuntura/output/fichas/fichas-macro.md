...
| | | | |
|---|---|---|---|
| **ITCM: 62,8** | **VERDE** | Moderadamente aflojado | 16 indicadores: 8 en verde · 4 en amarillo · 4 en naranja |
...
| Actividad económica | Si la economía crece o se contrae, y en cuántas partes: el EMAE interanual, cuántos de sus quince sectores crecen y la producción industrial manufacturera. | 55,9 | AMARILLO | 11,0 % |
...
| Actividad económica (EMAE i.a.) | El pulso mensual de la actividad económica: cuánto creció o cayó respecto de un año atrás. | 2,69 % i.a. | VERDE | 5,3 % |
| Amplitud del crecimiento (sectores en alza) | De los quince sectores en que el INDEC divide la actividad económica, cuántos crecen respecto de un año atrás. | 80 % de sectores en crecimiento i.a. | VERDE | 1,8 % |
| Producción industrial (IPI i.a.) | Cuánto produce la industria manufacturera respecto de un año atrás, promediado en tres meses. | −2,82 % i.a. (promedio 3 meses) | NARANJA | 1,8 % |
| Actividad tributaria (IVA-DGI + cheque) | Cuánto crecieron, en términos reales y respecto de un año atrás, el IVA-DGI y el impuesto a los créditos y débitos… | −5,41 % i.a. real (compuesto IVA-DGI/cheque) | NARANJA | 2,2 % |
...
| | | | |
|---|---|---|---|
| **Hoy: 1,66 % mensual** (2026-08) | **VERDE** | Peso efectivo 15,6 % del ITCM | Cinturón Macroeconomía |
...
| **SERIE DISPONIBLE** | 2021-10 → 2026-08 (59 puntos) | **REZAGO DE PUBLICACIÓN** | El INDEC difunde el IPC de cada mes a mediados del mes siguiente, según su calendario oficial. El informe lo incorpora en forma automática el mismo día de la publicación. |
...
| **MODO DE ACCESO** | Automático: el dato se extrae de la API pública y se publica sin intervención manual. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-09-16 |
...
- El informe publica el valor (1,66 % mensual) pero no los números que lo componen: la fuente entrega la serie ya calculada. Para auditar el dato hay que ir a la operación estadística citada más arriba.

## Color vigente y por qué

Dato vigente: 1,66 % mensual (2026-08).

1,66 % mensual cae en el tramo que corresponde a Verde, a 1,14 del corte más cercano.
...
| **MODO DE ACCESO** | Automático: se leen la planilla oficial del mes y el Balance Consolidado; el resultado se valida contra las reservas brutas de la API de estadísticas. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-16 |
...
| | | | |
|---|---|---|---|
| **Hoy: −0,26 σ vs. su historia** (2026-08) | **AMARILLO** | Peso efectivo 3,4 % del ITCM | Cinturón Macroeconomía |
...
| **SERIE DISPONIBLE** | 2023-11 → 2026-08 (34 puntos) | **REZAGO DE PUBLICACIÓN** | El IdC se publica para el último mes con IPC cerrado: unas dos semanas después de mediados del mes siguiente. |
...
| **MODO DE ACCESO** | Automático: API pública del BCRA y API de series de datos.gob.ar; el índice se calcula en el propio informe. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-09-16 |
...
Dato vigente: −0,26 σ vs. su historia (2026-08).

−0,26 σ vs. su historia cae en el tramo que corresponde a Amarillo, a 0,26 del corte más cercano.
...
| | | | |
|---|---|---|---|
| **Hoy: 2,69 % i.a.** (2026-06) | **VERDE** | Peso efectivo 5,3 % del ITCM | Cinturón Macroeconomía |
...
| **MODO DE ACCESO** | Automático: API pública de series de tiempo de datos.gob.ar. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-09-16 |
...
Ponderación vigente en el ITCM: 5,3 % efectivo. El color es una lectura adicional — no reemplaza ni cambia esta ponderación.
...
| | | | |
|---|---|---|---|
| **Hoy: 80 % de sectores en crecimiento i.a.** (2026-06) | **VERDE** | Peso efectivo 1,8 % del ITCM | Cinturón Macroeconomía |
...
| **MODO DE ACCESO** | Automático: API pública de series de tiempo de datos.gob.ar, en una única consulta con las quince series. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-09-16 |
...
Ponderación vigente en el ITCM: 1,8 % efectivo. El color es una lectura adicional — no reemplaza ni cambia esta ponderación.
...
| | | | |
|---|---|---|---|
| **Hoy: −2,82 % i.a. (promedio 3 meses)** (2026-07) | **NARANJA** | Peso efectivo 1,8 % del ITCM | Cinturón Macroeconomía |
...
| **MODO DE ACCESO** | Automático: descubre el enlace a la planilla anual vigente desde la página oficial de la operación. Usa niveles originales a precisión completa y exige meses consecutivos. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-16 |
...
| | | | |
|---|---|---|---|
| **Hoy: −5,41 % i.a. real (compuesto IVA-DGI/cheque)** (2026-08) | **NARANJA** | Peso efectivo 2,2 % del ITCM | Cinturón Macroeconomía |
...
| **SERIE DISPONIBLE** | 2021-01 → 2026-08 (68 puntos) | **REZAGO DE PUBLICACIÓN** | Es la lectura más fresca de la dimensión de actividad: la Secretaría de Hacienda/ARCA informa IVA-DGI y créditos/débitos bancarios de un mes dentro del mes siguiente, antes de que el INDEC cierre el EMAE del mismo período. Medido el 16-sep-2026 contra el último mes calendario cerrado (agosto): este indicador publica ese mismo mes (0 de atraso), el IPI manufacturero un mes de atraso, y el EMAE y su difusión sectorial dos. |
...
| **MODO DE ACCESO** | Automático: se descubre la planilla vigente desde el catálogo INDEC y se completa la historia de la API; la tarjeta y el gráfico comparten esa serie. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-16 |
...
| | | | |
|---|---|---|---|
| **Hoy: 91,3 índice (100 = 4T-2023)** (2026-08) | **AMARILLO** | Peso efectivo 7,2 % del ITCM | Cinturón Macroeconomía |
...
| **SERIE DISPONIBLE** | 2022-01 → 2026-08 (56 puntos) | **REZAGO DE PUBLICACIÓN** | Las dos fuentes publican en los primeros días del mes siguiente, y el indicador espera el índice de precios que lleva las cifras a pesos constantes: el último punto es el del último mes con inflación publicada. |
...
Dato vigente: 91,3 índice (100 = 4T-2023) (2026-08).

91,3 índice (100 = 4T-2023) cae en el tramo que corresponde a Amarillo, a 3,7 del corte más cercano.
...
| | | | |
|---|---|---|---|
| **Hoy: 85,53 Índice (base dic-2015=100)** (2026-08) | **AMARILLO** | Peso efectivo 11 % del ITCM | Cinturón Macroeconomía |
...
| **MODO DE ACCESO** | Automático: descarga y lectura de la planilla oficial; una sola descarga por actualización sirve al índice y a los bilaterales de contexto. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-09-16 |
...
- El informe publica el valor (85,53 Índice (base dic-2015=100)) pero no los números que lo componen: la fuente entrega la serie ya calculada. Para auditar el dato hay que ir a la operación estadística citada más arriba.

## Color vigente y por qué

Dato vigente: 85,53 Índice (base dic-2015=100) (2026-08).

85,53 Índice (base dic-2015=100) cae en el tramo que corresponde a Amarillo, a 3,53 del corte más cercano.
...
| **MODO DE ACCESO** | Automático: API pública del BCRA. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-09-16 |
...
| **MODO DE ACCESO** | Automático: API monetaria del BCRA y planilla acumulativa del anexo estadístico del mercado de cambios y balance cambiario. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-16 |
...
| **SERIE DISPONIBLE** | 2023-10 → 2026-07 (34 puntos) | **REZAGO DE PUBLICACIÓN** | El titular se calcula al último mes común de la construcción (ISAC) y los bienes de capital importados (~2 meses y medio); el componente más fresco se muestra como provisorio sin puntuar. |
...
| **MODO DE ACCESO** | Automático: descubre las planillas originales vigentes del ISAC y del ICA; para BK, el original reemplaza íntegramente su ventana y la API conserva sólo la historia anterior; los patentamientos comerciales se acumulan mes a mes desde el portal de datos de justicia (la fuente solo publica el mes corriente). | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-16 |
...
| | | | |
|---|---|---|---|
| **Hoy: −0,8 % i.a. real (crédito en pesos)** (2026-08) | **NARANJA** | Peso efectivo 3,2 % del ITCM | Cinturón Macroeconomía |
...
| **SERIE DISPONIBLE** | 2024-01 → 2026-08 (32 puntos) | **REZAGO DE PUBLICACIÓN** | El stock del BCRA es diario, pero el titular espera el IPC que lo deflacta: el dato fresco se muestra como provisorio sin puntuar. |
...
| **MODO DE ACCESO** | Automático: API pública del BCRA y API de series de datos.gob.ar. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-09-16 |
...
Dato vigente: −0,8 % i.a. real (crédito en pesos) (2026-08).

−0,8 % i.a. real (crédito en pesos) cae en el tramo que corresponde a Naranja, a 2,55 del corte más cercano.
...
| | | | |
|---|---|---|---|
| **Hoy: 7,29 % real anual (TIREA vs. inflación esperada REM)** (2026-08) | **VERDE** | Peso efectivo 4 % del ITCM | Cinturón Macroeconomía |
...
| **MODO DE ACCESO** | Automático: planilla anual, gacetillas incluidas en el registro de meses completos y expectativas BCRA. Incorporar otro mes al registro requiere revisar su cobertura. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-08 · informe generado el 2026-09-16 |
...
Dato vigente: 7,29 % real anual (TIREA vs. inflación esperada REM) (2026-08).

7,29 % real anual (TIREA vs. inflación esperada REM) cae en el tramo que corresponde a Verde, a 5,21 del corte más cercano.
...
| **MODO DE ACCESO** | Automático: API de series de tiempo del Estado nacional. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-16 |
