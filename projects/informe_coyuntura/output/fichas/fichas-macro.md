...
| | | | |
|---|---|---|---|
| **ITCM: 65,0** | **VERDE** | Moderadamente aflojado | 15 indicadores: 8 en verde · 5 en amarillo · 2 en naranja |
...
| Inversión | Si alguien está apostando al futuro: la inversión física —construcción y bienes de capital—, que desde agosto de 2026 es el único componente que puntúa. | 59,2 | AMARILLO | 12,0 % |
...
| **DIMENSIÓN: Inversión** | | | | |
| Inversión física (IAI) | Índice Anticipador de Inversión. | −0,18 % i.a. ponderado | AMARILLO | 12,0 % |
...
| **MODO DE ACCESO** | Automático: API pública de series de tiempo; el saldo se calcula en el propio informe. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-09-08 |
...
| | | | |
|---|---|---|---|
| **Hoy: −0,18 % i.a. ponderado** (2026-06) | **AMARILLO** | Peso efectivo 12 % del ITCM | Cinturón Macroeconomía |
...
| **MODO DE ACCESO** | Automático: API de series de datos.gob.ar; los patentamientos comerciales se acumulan mes a mes desde el portal de datos de justicia (la fuente solo publica el mes corriente). | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-06 · informe generado el 2026-09-08 |
...
| **MODO DE ACCESO** | Automático: planilla oficial de cada año y serie de expectativas del BCRA. | **ÚLTIMA ACTUALIZACIÓN** | Dato a 2026-07 · informe generado el 2026-09-08 |
