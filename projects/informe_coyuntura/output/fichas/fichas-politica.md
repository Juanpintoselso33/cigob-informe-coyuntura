...
| Judicialización de la agenda | Qué porcentaje de los fallos publicados en jurisdicción federal y nacional involucra una medida cautelar. | 1,61 % de sumarios con medida cautelar | AMARILLO | 3,0 % |
...
| Conflictividad social (país) | Cuántos eventos de protesta y disturbios hubo en todo el país en los últimos 12 meses completos, comparados contra el… | −24,1 % vs 2023 | AMARILLO | 10,0 % |
...
- En los últimos doce meses AEA y UIA se pronunciaron 7 veces sobre medidas del Gobierno nacional: 2 de apoyo y 5 de crítica. Saldo −0,429 en una escala de −1 (todo crítica) a +1 (todo apoyo). Hay 10 comunicados detectados sin codificar.
...
| | | | |
|---|---|---|---|
| **Hoy: −24,1 % vs 2023** (2026-07) | **AMARILLO** | Peso efectivo 10 % del ITCP | Cinturón Política |
...
- 99,8% = Diputados 99,9% (peso 65%, 33 actas) · Senado 99,5% (peso 35%, 21 actas)
...
| | | | |
|---|---|---|---|
| **Hoy: 1,61 % de sumarios con medida cautelar** (2026-01) | **AMARILLO** | Peso efectivo 3 % del ITCP | Cinturón Política |
...
- 107 de 6644 sumarios de jurisdicción federal y nacional publicados en 2026 mencionan una medida cautelar. Se publica la proporción y no el conteo porque el volumen que la base publica varía por razones editoriales.

## Color vigente y por qué

Dato vigente: 1,61 % de sumarios con medida cautelar (2026-01).

1,61 % de sumarios con medida cautelar cae en el tramo que corresponde a Amarillo, a 0,13 del corte más cercano.
